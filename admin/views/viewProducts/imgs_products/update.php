<div class="app-title">
    <ul class="app-breadcrumb breadcrumb">
        ...
        <li class="breadcrumb-item "><a href="<?= BASE_URL_ADMIN . '?act=imgs' ?>">
                <b>Danh sách ảnh sản phẩm</b></a>
        </li>
        <li class="breadcrumb-item"><a href="#">Sửa ảnh sản phẩm</a></li>
    </ul>
    <div id="clock"></div>
</div>
<div class="row">
    <div class="col-md-12">
        ...
        <div class="tile">
            ...
            <h3 class="tile-title">Sửa ảnh sản phẩm</h3>
            <div class="tile-body">
            </div>
            ...
            <div class="form-group col-md-4">
                        ...
                        <select name="img_pro" class="form-control" id="exampleSelect2" >
                            <option value=""> -- Chọn tên nước hoa -- </option>
                            <?php foreach ($products as $product): ?>
                                <option <?= ($product['id'] == $imgs_pro['product_id']) ? 'selected' : null ?>
                                 value="<?= $product['id'] ?>">
                                    <?= $product['name'] ?>
                                </option>
                            <?php endforeach; ?>
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <div id="thumbbox">
                            <img src="<?= BASE_URL . $imgs_pro['img'] ?>" height="300" width="300" alt="Thumb image" id="thumbimage" />
