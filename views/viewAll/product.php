      ...
      <div class="layout-collection">
            ...
            <div class="section-box-bg">
              ...
              <div class="filter-content aside-hidden-mobile">
                <div class="filter-container">
                  ...
                  >
                    <div
                      class="filter-container__selected-filter-header clearfix"
                    >
                      <span
                      ...
                      <ul>
                        ...
                        >
                          <span>
                            <label
                              ...
                              for="filter-2-000-000d-5-000-000d"
                            >
                              <input
                                type="checkbox"
                                id="filter-2-000-000d-5-000-000d"
                                data-group="Khoảng giá"
                                data-field="price_min"
                        ...
                        >
                          <span>
                            <label
                              data-filter="10-000-000d"
                              for="filter-tren10-000-000d"
                            >
                              <input
                                type="checkbox"
                                id="filter-tren10-000-000d"
                                data-group="Khoảng giá"
                                data-field="price_min"
                        ...
                        >
                          <span>
                            <label for="filter-nuoc-hoa-unisex">
                              <input
                                type="checkbox"
                                id="filter-nuoc-hoa-unisex"
                                data-group="PRODUCT_TYPE"
                                data-field="product_type.filter_key"
                                data-text=""
                                value="(&#34;Nước hoa unisex&#34;)"
                                data-operator="OR"
                              />
                              <i class="fa"></i>
                              Nước hoa unisex
                        ...
                        >
                          <span>
                            <label for="filter-christian-dior">
                              <input
                                type="checkbox"
                                id="filter-christian-dior"
                                data-group="Hãng"
                                data-field="vendor"
                                data-text="Christian Dior"
                        ...
                        >
                          <span>
                            <label for="filter-elixir-precious">
                              <input
                                type="checkbox"
                                id="filter-elixir-precious"
                                data-group="Hãng"
                                data-field="vendor"
                                data-text="Elixir Precious"
                                value="(Elixir Precious)"
                                data-operator="OR"
                              />
                              <i class="fa"></i>
                              Elixir Precious
          ...
          <div class="block-collection">
            <div class="section-box-bg">
              ...
              >
                ...
                <div class="pagenav">
                  <nav
                    class="collection-paginate clearfix relative nav_pagi w_100"
                  >
            ...
            <div class="view_mores">
              <a class="one"
                ...
                <img
                  width="90"
                  height="90"
                  src="../../bizweb.dktcdn.net/100/503/826/themes/932476/assets/sortdown02fb.png?1709175143725"
                  alt="Bean Perfume"
              /></a>
              <a class="two active"
                >Thu gọn
        ...
        <div class="collection_scrolltabs">
          <div class="toolbar-inner">
            <a class="tab-item tab-filter" title="Lọc"
              ><i class="evo-icon icon-filter"></i
              ><span class="tabbar-label">Lọc</span></a
            >
            <a class="tab-item tab-sort" title="Sắp xếp"
              ><i class="evo-icon icon-sort"></i
              ><span class="tabbar-label">Sắp xếp</span></a
            >
          </div>
        </div>
      </div>
