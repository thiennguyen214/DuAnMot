              ...
              <div id="sort-by">
                ...
                <ul id="sortBy">
                  <li>
                    ...
                    <ul>
                      <li>
                        <a href="javascript:;" onclick="sortby('default')" title="Mặc định">Mặc định</a>
                      </li>
                      <li>
                        <a href="javascript:;" onclick="sortby('alpha-asc')" title="A &rarr; Z">A &rarr; Z</a>
                      </li>
                      <li>
                        <a href="javascript:;" onclick="sortby('alpha-desc')" title="Z &rarr; A">Z &rarr; A</a>
                      </li>
                      <li>
                      ...
                      <li>
                        <a href="javascript:;" onclick="sortby('created-desc')" title="Hàng mới nhất">Hàng mới nhất</a>
                      </li>
                      <li>
                        <a href="javascript:;" onclick="sortby('created-asc')" title="Hàng cũ nhất">Hàng cũ nhất</a>
                      </li>
                    </ul>
                  </li>
                </ul>
                      ...
                      <form action="https://bean-perfume.mysapo.net/cart/add" method="post"
                        ...
                        <div class="product-thumbnail">
                          <a class="image_thumb scale_hover" href="../unisex-creed-millesime-imperial.html"
                            ...
                            <img width="480" height="480" class="lazyload image1" src="<?= BASE_URL . $product['img'] ?>"
                              data-src="<?= BASE_URL . $product['img'] ?>" alt="Unisex Creed Millesime Imperial" />
                          </a>
                          <div class="action">
