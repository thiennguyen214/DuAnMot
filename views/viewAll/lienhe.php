          ...
          <div class="row">
            <div class="col-lg-6 col-12">
              <div class="contact">
                ...
                <div class="des_foo">
                  Với sứ mệnh "Khách hàng là ưu tiên số 1" chúng tôi luôn mạng
              ...
              <div class="form-contact">
                ...
                <div id="pagelogin">
                  <form
                    method="post"
                    action="https://bean-perfume.mysapo.net/postcontact"
                    id="contact"
                  ...
                  >
                    ...
                    /><input name="utf8" type="hidden" value="true" /><input
                      type="hidden"
                      id="Token-8a10dc70744b45099dfda5b18e1ed9ab"
                      name="Token"
                    />
                    <script src="<?= BASE_URL ?>assets/client/www.google.com/recaptcha/apif78f.js?render=6Ldtu4IUAAAAAMQzG1gCw3wFlx_GytlZyLrXcsuK"></script>
                    <script>
                      grecaptcha.ready(function () {
                        grecaptcha
                          .execute("6Ldtu4IUAAAAAMQzG1gCw3wFlx_GytlZyLrXcsuK", {
                            action: "contact",
                          })
                          .then(function (token) {
                            document.getElementById(
                              "Token-8a10dc70744b45099dfda5b18e1ed9ab"
                            ).value = token;
                          });
                      });
                    </script>
