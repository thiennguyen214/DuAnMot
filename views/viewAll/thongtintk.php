<body class="body-customers">
    ...
    <div class="popup-search">
        ...
        <div class="product-search">
            ...
            <div class="item">
                <div class="image">
                    <a class="image_thumb" href="/unisex-creed-millesime-imperial"
                        title="Unisex Creed Millesime Imperial">
                        <img width="100" height="100" class="lazyload"
                            src="//bizweb.dktcdn.net/100/503/826/themes/932476/assets/lazy.png?1711356971279"
                ...
                <div class="content">
                    <h3 class="product-name"><a class="line-clamp line-clamp-1" href="/unisex-creed-millesime-imperial"
            ...
            <div class="item">
                <div class="image">
                    <a class="image_thumb" href="/nuoc-hoa-unisex-gucci-the-virgin-violet"
                ...
                <div class="content">
                    <h3 class="product-name"><a class="line-clamp line-clamp-1"
                            href="/nuoc-hoa-unisex-gucci-the-virgin-violet"
            ...
            <div class="item">
                <div class="image">
                    <a class="image_thumb" href="/gucci-bloom-ambrosia-di-fiori" title="Gucci Bloom Ambrosia di Fiori">
                        <img width="100" height="100" class="lazyload"
                            src="//bizweb.dktcdn.net/100/503/826/themes/932476/assets/lazy.png?1711356971279"
                ...
                <div class="content">
                    <h3 class="product-name"><a class="line-clamp line-clamp-1" href="/gucci-bloom-ambrosia-di-fiori"
            ...
            <div class="item">
                <div class="image">
                    <a class="image_thumb" href="/calvin-klein-ck-one-gold" title="Calvin Klein CK One Gold">
                        <img width="100" height="100" class="lazyload"
                            src="//bizweb.dktcdn.net/100/503/826/themes/932476/assets/lazy.png?1711356971279"
                ...
                <div class="content">
                    <h3 class="product-name"><a class="line-clamp line-clamp-1" href="/calvin-klein-ck-one-gold"
            ...
            <div class="item">
                <div class="image">
                    <a class="image_thumb" href="/nuoc-hoa-le-labo-santal-33" title="Nước hoa Le Labo Santal 33">
                        <img width="100" height="100" class="lazyload"
                            src="//bizweb.dktcdn.net/100/503/826/themes/932476/assets/lazy.png?1711356971279"
                ...
                <div class="content">
                    <h3 class="product-name"><a class="line-clamp line-clamp-1" href="/nuoc-hoa-le-labo-santal-33"
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-12 col-lg-9 col-right-ac">
                        ...
                        <div class="form-signup name-account m992">
                            <p><strong>Họ tên:</strong> TÚ TRƯƠNG</p>
                            <p> <strong>Email:</strong> tuttph45304@fpt.edu.vn</p>

                            <p> <strong>Điện thoại:</strong> +84332390286 </p>



                            <p><strong>Địa chỉ :</strong> Khu 10 Đại Phúc, Thành Phố Bắc Ninh, Bắc Ninh, Quận Đống Đa,
                                Hà Nội, Vietnam</p>
