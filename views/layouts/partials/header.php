		...
		<div class="container">
			<div class="row">
				...
				<div class="col-xl-3 col-lg-3 cs_hea">
					<a href="<?= BASE_URL ?>assets/client/he-thong-cua-hang.html" title="Hệ thống cửa hàng">
						Hệ thống cửa hàng
					</a>
				</div>
			</div>
						...
						<nav class="header-nav">
							...
							<ul class="item_big">
								...
								<li class="nav-item <?= (isset($active3)) ? $active3 : null ?> has-mega">
									<a class="a-img caret-down a-index" href="<?= BASE_URL ?>?act=brand"
										title="Thương hiệu">
										Thương hiệu
									</a>
									...
									<ul class="item_small d-lg-none d-block">
										<li>
											...
											<ul>
												...
												<li>
													<a href="ariana-grande.html" title="Ariana Grande" class="a3">Ariana
														Grande</a>
												</li>
												<li>
										...
										<li>
											...
											<ul>
												...
												<li>
													<a href="calvin-klein.html" title="Calvin Klein" class="a3">Calvin
														Klein</a>
												</li>
											</ul>
										</li>
								...
								<li class="nav-item <?= (isset($active4)) ? $active4 : null ?>">
									<a class="a-img caret-down a-index" href="<?= BASE_URL ?>?act=products"
										title="Sản phẩm">
										Sản phẩm
									</a>
									<i class="fa fa-caret-down"></i>
